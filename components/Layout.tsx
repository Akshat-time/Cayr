          ...
          {navItems.map((item) => {
            ...
            return (
              <button 
                ...
                className={`w-full sidebar-item p-3.5 lg:px-4 lg:py-3.5 rounded-2xl flex items-center justify-center lg:justify-start space-x-4 transition-all relative outline-none focus:ring-2 focus:ring-blue-500/40 ${
                  isActive
