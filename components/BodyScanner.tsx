                  ...
                  return (
                    ...
                    >
                      ...
                      {(selection || isHovered) && (
                        ...
                        >
                           <div className="bg-white px-3 py-1.5 rounded-lg text-[9px] font-black text-slate-950 uppercase tracking-widest shadow-2xl inline-block border-l-4 border-blue-600 pointer-events-none">
                             {zone.label}
                           </div>
                        </foreignObject>
                      )}
               ...
               selectedAreas.map(area => (
                 <div key={area.id} className="p-10 bg-white border border-slate-100 rounded-[48px] shadow-sm space-y-8 animate-in slide-in-from-right-4">
                    <div className="flex justify-between items-center">
                       ...
                       <div className={`w-16 h-16 rounded-3xl flex items-center justify-center text-2xl font-black shadow-xl transition-all ${
                          area.intensity >= 8 ? 'bg-rose-500 text-white shadow-rose-200' : area.intensity >= 5 ? 'bg-amber-500 text-white shadow-amber-200' : 'bg-emerald-500 text-white shadow-emerald-200'
                       }`}>
                          {area.intensity}
                       </div>
                    </div>
